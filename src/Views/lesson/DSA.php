...
<head>
    ...
    <style>
        ...
        .leftSidebar {
            width: 280px; /* Fixed width for leftSidebar */
        ...
        .main-content {
            margin-left: 280px; /* Same as leftSidebar width */
            padding: 20px;
            flex-grow: 1;
        ...
        /* Custom scrollbar for terminal and leftSidebar */
        ::-webkit-scrollbar {
            width: 8px;
            height: 8px;
        }
...
<body>
    ...
    <nav id="leftSidebar" class="leftSidebar">
...
myQueue.isEmpty();
        ...
        function showTopic(topicId) {
            ...
            // Update active link in leftSidebar
            ...
            if (activeLink) {
             ...
             // For mobile: hide leftSidebar after selection
            if (window.innerWidth <= 768) {
                leftSidebar.classList.add('leftSidebar-hidden');
                leftSidebar.classList.remove('leftSidebar-visible');
                mainContent.classList.remove('main-content-full'); // Ensure main content is not full width when leftSidebar is programmatically hidden
            }
        }
        
        // Populate leftSidebar and content sections
        ...
        menuButton.addEventListener('click', () => {
            leftSidebar.classList.toggle('leftSidebar-hidden');
            leftSidebar.classList.toggle('leftSidebar-visible');
             // Adjust main content margin if leftSidebar is visible
            if (leftSidebar.classList.contains('leftSidebar-visible')) {
        ...
        // Close leftSidebar when clicking outside on mobile
        mainContent.addEventListener('click', () => {
            if (window.innerWidth <= 768 && leftSidebar.classList.contains('leftSidebar-visible')) {
                leftSidebar.classList.add('leftSidebar-hidden');
                leftSidebar.classList.remove('leftSidebar-visible');
                mainContent.classList.remove('main-content-full');
            }
